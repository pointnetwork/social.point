...
class CommentManager {
    ...
    static addComment = async (postId, storageId) => point.contractSend("PointSocial", "addCommentToPost", [postId, storageId]);
    static deleteComment = async (postId, commentId) => point.contractSend("PointSocial", "deleteCommentForPost", [postId, commentId]);
    static editComment = async (commentId, contentId) => point.contractSend("PointSocial", "editCommentForPost", [commentId, contentId]);
}
